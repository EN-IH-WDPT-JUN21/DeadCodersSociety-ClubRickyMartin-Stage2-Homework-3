    ...
    while (runProgram) {
      ...
      switch (command) {
        ...
        case "reportleadbysalesrep" -> {
          for (String record : leadRepository.reportLeadBySalesRep()) {
            System.out.println(record);
          }
        }
        case "reportopportunitybysalesrep" -> {
          for (String record : opportunityRepository.reportOpportunityBySalesRep()) {
            System.out.println(record);
          }
        }
        case "reportclosed-wonbysalesrep" -> {
          for (String record : opportunityRepository.reportCLOSEDWONbySalesRep()) {
            System.out.println(record);
          }
        }
        case "reportclosed-lostbysalesrep" -> {
          for (String record : opportunityRepository.reportCLOSEDLOSTbySalesRep()) {
            System.out.println(record);
          }
        }
        case "reportopenbysalesrep" -> {
          for (String record : opportunityRepository.reportOPENbySalesRep()) {
            System.out.println(record);
          }
        }
        case "reportopportunitybytheproduct" -> {
          for (String record : opportunityRepository.reportOpportunitybytheproduct()) {
            System.out.println(record);
          }
        }
        case "reportclosed-wonbytheproduct" -> {
          for (String record : opportunityRepository.reportCLOSEDWONbytheproduct()) {
            System.out.println(record);
          }
        }
        case "reportclosed-lostbytheproduct" -> {
          for (String record : opportunityRepository.reportCLOSEDLOSTbytheproduct()) {
            System.out.println(record);
          }
        }
        case "reportopenbytheproduct" -> {
          for (String record : opportunityRepository.reportOPENbytheproduct()) {
            System.out.println(record);
          }
        }
        case "reportopportunitybycountry" -> {
          for (String record : opportunityRepository.reportOpportunitybyCountry()) {
            System.out.println(record);
          }
        }
        case "reportclosed-wonbycountry" -> {
          for (String record : opportunityRepository.reportCLOSEDWONbyCountry()) {
            System.out.println(record);
          }
        }
        case "reportclosed-lostbycountry" -> {
          for (String record : opportunityRepository.reportCLOSEDLOSTbyCountry()) {
            System.out.println(record);
          }
        }
        case "reportopenbycountry" -> {
          for (String record : opportunityRepository.reportOPENbyCountry()) {
            System.out.println(record);
          }
        }
        case "reportopportunitybycity" -> {
          for (String record : opportunityRepository.reportOpportunitybyCity()) {
            System.out.println(record);
          }
        }
        case "reportclosed-wonbycity" -> {
          for (String record : opportunityRepository.reportCLOSEDWONbyCity()) {
            System.out.println(record);
          }
        }
        case "reportclosed-lostbycity" -> {
          for (String record : opportunityRepository.reportCLOSEDLOSTbyCity()) {
            System.out.println(record);
          }
        }
        case "reportopenbycity" -> {
          for (String record : opportunityRepository.reportOPENbyCity()) {
            System.out.println(record);
          }
        }
        case "reportopportunitybyindustry" -> {
          for (String record : opportunityRepository.reportOpportunitybyIndustry()) {
            System.out.println(record);
          }
        }
        case "reportclosed-wonbyindustry" -> {
          for (String record : opportunityRepository.reportCLOSEDWONbyIndustry()) {
            System.out.println(record);
          }
        }
        case "reportclosed-lostbyindustry" -> {
          for (String record : opportunityRepository.reportCLOSEDLOSTbyIndustry()) {
            System.out.println(record);
          }
        }
        case "reportopenbyindustry" -> {
          for (String record : opportunityRepository.reportOPENbyIndustry()) {
            System.out.println(record);
          }
        }
        case "meanemployeecount" -> {
          for (String record : accountRepository.meanEmployeeCount()) {
            System.out.println(record);
          }
        }
        case "medianemployeecount" -> {
          for (String record : accountRepository.medianEmployeeCount()) {
            System.out.println(record);
          }
        }
        case "maxemployeecount" -> {
          for (String record : accountRepository.maxEmployeeCount()) {
            System.out.println(record);
          }
        }
        case "minemployeecount" -> {
          for (String record : accountRepository.minEmployeeCount()) {
            System.out.println(record);
          }
        }
        case "meanquantity" -> {
          for (String record : accountRepository.meanQuantity()) {
            System.out.println(record);
          }
        }
        case "medianquantity" -> {
          for (String record : accountRepository.medianQuantity()) {
            System.out.println(record);
          }
        }
        case "maxquantity" -> {
          for (String record : accountRepository.maxQuantity()) {
            System.out.println(record);
          }
        }
        case "minquantity" -> {
          for (String record : accountRepository.minQuantity()) {
            System.out.println(record);
          }
        }
        case "meanoppsperaccount" -> {
          for (String record : accountRepository.meanOppsperAccount()) {
            System.out.println(record);
          }
        }
        case "medianoppsperaccount" -> {
          for (String record : accountRepository.medianOppsperAccount()) {
            System.out.println(record);
          }
        }
        case "maxoppsperaccount" -> {
          for (String record : accountRepository.maxOppsperAccount()) {
            System.out.println(record);
          }
        }
        case "minoppsperaccount" -> {
          for (String record : accountRepository.minOppsperAccount()) {
            System.out.println(record);
          }
        }
  ...
  public void showLeads() {
    if (leadRepository.findAll().size() == 0) {
      ...
      for (Lead lead : leadRepository.findAll()) {
        String str = "Id: ".concat(String.valueOf(lead.getId()))
