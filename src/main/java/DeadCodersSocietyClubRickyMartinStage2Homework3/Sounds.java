...
public class Sounds {
  ...
  public static File getAudioDirectory() {
    try {
      URL audioDirectoryUrl = Sounds.class.getClassLoader().getResource("audio");
      if (null == audioDirectoryUrl) return null;
      return new File(audioDirectoryUrl.toURI());
    } catch (URISyntaxException e) {
      //throw new Exception("Error with getting audio/ directory", e);
      return null;
    }
  }
}
